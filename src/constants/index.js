export const navLinks = [
  ...
  export const myProjects = [
    ...
    {
      title: 'StableMax - Text to Image Generator For Free',
      desc: 'StableMax is a free text-to-image generator built with Next.js, offering fast, secure, and scalable image generation. It leverages server-side rendering, Prisma with Postgres (neonDB), and Framer Motion animations, providing a seamless and efficient user experience.',
      subdesc:
        'Developed using Next.js, TypeScript, Tailwind CSS, Prisma, and Shadcn UI, StableMax ensures optimized image processing, easy authentication with NextAuth, and responsive UI components. With Vercel deployment, it offers a highly maintainable and secure platform for effortless text-to-image conversion.',
      href: 'https://stable-max-green.vercel.app',
      texture: '/textures/project/Pro2.mp4',
      logo: '/assets/project-logo/Pro2.png',
      logoStyle: {
        backgroundColor: '#2A1816',
        border: '0.2px solid #36201D',
        boxShadow: '0px 0px 60px 0px #AA3C304D',
    ...
    },
    {
      ...
      logo: '/assets/project-logo/Pro3.svg',
      logoStyle: {
    ...
    },
    {
      ...
      texture: '/textures/project/Pro5.mp4',
      logo: '/assets/project-logo/Pro5.png',
      logoStyle: {
  ...
  export const workExperiences = [
    {
      ...
      title: "Passionate Web Developer: Crafting and Deploying Responsive Websites with HTML, CSS, JavaScript, and ReactJS, While Debugging and Enhancing Full-Stack Applications for Seamless User Experiences.",
      icon: '/assets/elite_softwares_pvt_ltd__logo.jpg',
      animation: 'salute',
    },
    // {
    //   id: 2,
